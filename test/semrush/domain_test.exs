defmodule SemrushTest do
  ...
  test "returns a domain's organic search keywords" do
    ...
    assert Domain.search_keywords("thinkspeakcode.com") == expected_results
  end
  ...
  test "returns a domain's paid keywords" do
    ...
    assert Domain.paid_keywords("thinkspeakcode.com") == expected_results
  end

  test "returns a domain's overview" do
    expected_results = [%{"Database" => "us", "Date" => "20160906", "PLA keywords" => "0", "PLA uniques" => "0", "Adwords Cost" => "158", "Adwords Keywords" => "32", "Adwords Traffic" => "2", "Domain" => "thinkspeakcode.com", "Organic Cost" => "0", "Organic Keywords" => "12", "Organic Traffic" => "0", "Rank" => "39288734"}]
    assert Domain.overview("thinkspeakcode.com") == expected_results
  end
