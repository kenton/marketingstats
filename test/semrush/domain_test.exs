defmodule SemrushTest do
  ...
  test "returns a domain's organic search keywords" do
    ...
    assert Domain.search_keywords(domain: "thinkspeakcode.com") == expected_results
  end
  ...
  test "returns a domain's paid keywords" do
    ...
    assert Domain.paid_keywords(domain: "thinkspeakcode.com") == expected_results
  end

  # test "returns a domain's overview" do
  #   expected_results = []
  #   assert Domain.overview == expected_results
  # end
