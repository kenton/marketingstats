defmodule Semrush.Api.SemrushApiMock do
  ...
  def search_keywords(_domain) do
  ...
  def overview(_domain) do
    response = %{body: "Date;Database;Domain;Rank;Organic Keywords;Organic Traffic;Organic Cost;Adwords Keywords;Adwords Traffic;Adwords Cost;PLA keywords;PLA uniques\r\n20160906;us;thinkspeakcode.com;39288734;12;0;0;32;2;158;0;0\r\n",
                  headers: %HTTPotion.Headers{hdrs: headers},
                  status_code: 200}
  ...
  def headers do
    ["cache-control":           "max-age=3600",
      ...
      expires:                  "Sat, 20 Aug 2016 01:29:00 GMT", 
      server:                   "nginx/1.9.13",
